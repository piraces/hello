 ...
 * 	 each key can map to at most one value. This interface takes the place of the Dictionary class,
 ...
 *   collection of values, or set of key-value mappings. The order of a map is defined as the order in which 
