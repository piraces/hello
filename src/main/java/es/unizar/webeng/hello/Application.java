...
/**
 * The @SpringBootApplication annotation configures the web application,
 * adding automatically all the configurations of Spring and JEE,
 * which normally had to be done manually. The @SpringBootApplication
 * annotation is equivalent to using @Configuration, 
 * @EnableAutoConfiguration and @ComponentScan with their default
 * attributes. 
 */
 /**
 * The @ComponentScan annotation tells Spring to look for
