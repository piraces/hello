...
User name | NIA | Travis-CI|CodeCov|Heroku|Coverity|Score
----------|-----|----------|-------|------|--------|-----------
...
[Jorge Cáncer Gil] (https://github.com/jorcox/hello) | 646122 | [![Build Status](https://travis-ci.org/jorcox/hello.svg)](https://travis-ci.org/jorcox/hello) | [![codecov.io](http://codecov.io/github/jorcox/hello/coverage.svg?branch=master)](http://codecov.io/github/jorcox/hello?branch=master) | ![Coverity] (https://scan.coverity.com/projects/6510/badge.svg) | [App](http://jorcox-hello.herokuapp.com)
