...
###What does it do?
JDepend makes a report with that fields:
Term			Description
...
Cycles(V)			Packages participating in a package dependency cycle are in a deadly embrace with respect to reusability and their release cycle. Package dependency cycles can be easily 				identified by reviewing the textual reports of dependency cycles. Once these dependency cycles have been identified with JDepend, they can be broken by employing various 				object-oriented techniques.

###How to use it?
It will be use automatically with gradle check and it will create a xml report in /build/reports/jdepend from test and main folders. You can also use it with gradle jdependMain if you only want to have a report from main folder or jdependTest if you want a report from test folder.
